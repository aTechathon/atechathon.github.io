	...
	V3TB.addThreeBrowseTab = function() {
		var tab = JA.menu.appendChild( document.createElement( 'div' ) );
		tab.title = 'View things from the Three.js repo';
		tab.innerHTML =
			'<a href=# id=tabThreeBrowse ><p class=button >' +
				'<i class="fa fa-wrench"></i> Three.js Browse...' +
			'</p></a>';
		tabThreeBrowse.onclick = function() {JA.toggleTab( V3TB.ThreeBrowseTab ); };

		V3TB.ThreeBrowseTab = tab.appendChild( document.createElement( 'div' ) );
		V3TB.ThreeBrowseTab.style.cssText = 'cursor: auto; display: none; ' ;
		V3TB.ThreeBrowseTab.innerHTML = "hi";

		var fileList = '<br>';
		var file;
		for ( var i = 0, len = V3TB.files.length; i < len; i++ ) {
			file = V3TB.files[ i ];
			fileList += '<a href=JavaScript:V3TB.updateIframe("' + i + '"); >' + file + '</a><br>';
		}
		V3TB.ThreeBrowseTab.innerHTML =
			'<h3>Three.js files</h3>' +
			'<p>Sourced from:<br><b><a href="http://threejs.org" target="_blank">Three.js</a></b></p>' +
			'<div >' + fileList + '</div>' +
			'<p style=text-align:right; >' +
				'<a class=button href=JavaScript:JA.toggleTab(V3TB.ThreeBrowseTab); ); >Close</a> ' +
			'</p>' +
		'';

	};

	V3TB.updateIframe = function ( index ) {
		var file = V3TB.files[ index ];
		var fname = 'http://atechathon.github.io/three.js/examples/' + file;
